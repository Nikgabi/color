    ...
    <div class="container">
      <div class="row">
        <div class="col-md-2 ">
		  ...
		  <div class="img-box">
            <img src="images/anxiety3.jpeg" alt="">
          </div><br>
		  <div class="img-box">
            <img src="images/anxiety4.jpeg" alt="">
          </div><br>
		  <div class="img-box">
		...
		<div class="col-md-10 ">
		<form name="depress" action="anxiety_score.php" style="display: flex;  align-items: center; margin-bottom: 20px;" method="POST" onsubmit="return FormValidate()">
                <label>
