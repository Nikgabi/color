  ...
  <section class="about_section">
    <div class="container">
      <div class="row">
        <div class="col-md-2 ">
          <div class="img-box">
            <img src="images/appendix_1.jpeg" alt="">
          </div><br>
		  <div class="img-box">
            <img src="images/appendix_2.jpeg" alt="">
          </div><br>
		  <div class="img-box">
            <img src="images/appendix_3.jpeg" alt="">
          </div><br>
		  <div class="img-box">
            <img src="images/appendix_4.jpeg" alt="">
          </div><br>
		  <div class="img-box">
            <img src="images/appendix_5.jpeg" alt="">
          </div><br>
		...
		<form name="appendix" action="" style="display: flex;  align-items: center; margin-bottom: 20px;" method="POST" >
			...
			<?php $depress_id = $_SESSION['id_user'];
						$er1 = $_POST['er1'] ?? "";
						$er2 = $_POST['er2'] ?? "";
						$er3 = $_POST['er3'] ?? "";
						$er4 = $_POST['er4'] ?? "";
