...
if (isset($_POST['submit'])) {
    ...
    if (empty($kritiki)) {
        ...
        if ($query_run) {
            ...
            echo "<script>alert('Πρόβλημα κατά την καταχώρηση: " . mysqli_error($con) . "');</script>";
  ...
  <section class="about_section">
    <div class="container">
      <div class="row">
		...
		<br>
          <div class="img-box">
            <img src="<?php echo BASE_URL; ?>images/testimonials.jpg" alt="">
          </div><br>
		  <div class="img-box">
            <img src="<?php echo BASE_URL; ?>images/testimonials1.jpg" alt="">
          </div><br>
		...
		if (!isset($_SESSION['email'])) {
			...
			echo '<button style="background-color: rgb(162,235,182); padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;">
                <a href="' . BASE_URL . 'index.php" style="text-decoration: none; color: black;">Home</a>
            </button><br><br>';	
			echo '<button style="background-color: rgb(162,235,182); padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;">
                <a href="' . BASE_URL . 'auxi/kritikes.php" style="text-decoration: none; color: black;">Δείτε τις κριτικές</a>
            </button>';
		}
