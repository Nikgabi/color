    ...
    <div class="container">
      <div class="row">
        <div class="col-md-2 ">
		  ...
		  <div class="img-box">
            <img src="images/depres1.jpeg" alt="">
          </div><br>
		  <div class="img-box">
            <img src="images/depres2.jpeg" alt="">
          </div><br>
		  <div class="img-box">
            <img src="images/depres3.jpeg" alt="">
          </div><br>
		  <div class="img-box">
            <img src="images/depres6.jpeg" alt="">
          </div><br>
        </div>
		<div class="col-md-10 ">
		<form name="depress" action="depression_result.php" style="display: flex;  align-items: center; margin-bottom: 20px;" method="POST" onsubmit="return FormValidate()">
                <label>
