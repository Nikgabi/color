  ...
  <section class="about_section">
    <div class="container">
      <div class="row">
        <div class="col-md-2 ">
          <div class="img-box">
            <img src="<?php echo BASE_URL; ?>images/mikrob1.png" alt="">
          </div><br>
		  <div class="img-box">
            <img src="<?php echo BASE_URL; ?>images/mikrob2.jpeg" alt="">
          </div><br>
		  <div class="img-box">
            <img src="<?php echo BASE_URL; ?>images/mikrob3.jpeg" alt="">
          </div><br>
    ...
    <form name="loipes" action="" method="POST"  style="display: flex; flex-direction: column; align-items: center; gap: 15px;">
        ...
        <div style="display: flex; gap: 10px; flex-wrap: wrap; justify-content: center;">
            ...
            <button style="background-color: rgb(162,235,182); padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;">
                <a href="<?php echo BASE_URL; ?>calculation_istor.php" style="text-decoration: none; color: black;">Πίσω</a>
            </button>                                   
        </div>
    </form>
