...
<section class="about_section">
    <div class="container  ">
      <div class="row">
        <div class="col-md-3 ">
          <div class="img-box">
            <img src="<?php echo BASE_URL; ?>images/history1.jpg" alt="">
          </div>
        </div>
        ...
        <div class="col-md-9">
          ...
          <div class="detail-box">
			...
			<a href="' . BASE_URL . 'h_istory/istoriko.php">
              Εισαγωγή Ιστορικού
            </a>
			<a href="' . BASE_URL . 'h_istory/bioximiko.php">
              Βιοχημικές εξετάσεις
            </a>
			<a href="' . BASE_URL . 'h_istory/aimatologiko.php">
              Αιματολογικές εξετάσεις
            </a>
			<a href="' . BASE_URL . 'h_istory/ormon.php">
              Μικροβιολογικές κ.α εξετάσεις 
            </a>
			<a href="' . BASE_URL . 'h_istory/aktino.php">
              Απεικονιστικές εξετάσεις
            </a>
			<a href="' . BASE_URL . 'h_istory/loipes_exet.php">
              Λοιπές εξετάσεις
            </a>
			<a href="' . BASE_URL . 'h_istory/gnomat.php">
