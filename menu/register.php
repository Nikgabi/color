...
<section class="about_section">
    <div class="container">
      <div class="row">
        <div class="col-md-3 ">
          <div class="img-box">
            <img src="<?php echo BASE_URL; ?>images/treatment-side-img.jpg" alt="">
          </div>
        </div>
		<div class="col-md-9 ">
			...
			?>	
			<form name="reg_form"  action="<?php echo BASE_URL; ?>insert_new_user.php" method="POST" onsubmit="return FormValidate()">
