  ...
  <section class="about_section">
    <div class="container">
      <div class="row">
        <div class="col-md-2 ">
          <div class="img-box">
            <img src="images/mi_1.jpeg" alt="">
          </div><br>
		  <div class="img-box">
            <img src="images/mi_2.jpeg" alt="">
          </div><br>
		  <div class="img-box">
		...
		<form name="strock" action="cardiov.php" style="display: flex;  align-items: center; margin-bottom: 20px;" method="POST" onsubmit="return FormValidate()">
                <label>
