...
function send_password_reset($get_name,$get_email,$token){
    ...
    try {
        ...
        $email_template = "
            ...
            <br><br>
            <a href='http://localhost/ptyxiaki/change_password.php?token=$token&email=$get_email'>click Me</a>
        ";
            ...
            if($check_token_run && mysqli_num_rows($check_token_run)> 0)
                {
                    ...
                    {
                        $update_password="UPDATE user SET password='$password' WHERE verify_token='$token' LIMIT 1 ";
